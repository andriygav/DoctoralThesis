...
\begin{itemize}
    \justifying
    \item Ориентация на анализ худшего случая $\Rightarrow$ оценки существенно завышены для реальных данных.
...
\begin{rustheorem}[\emph{Киселев-Грабовой-Мешков}]
    \justifying
...
\begin{enumerate}
    ...
    \item Введены формальные определения меры сложности выборки и меры сложности модели, установлен критерий обучаемости модели на выборке.
    \item Введена ландшафтная мера сложности модели, определяемая через спектральные свойства матриц Гессе функции потерь.
    \item Теоретически доказана связь ландшафтной меры со сложностью выборки.
    \item Получены теоретические оценки ландшафтных мер на основе спектральных норм матриц Гессе для основных архитектур глубокого обучения: полносвязных, сверточных и трансформерных сетей.
    \item Доказаны теоремы о зависимости ландшафтных мер от глубины сети, размеров слоев и других структурных параметров архитектур.
    \item Доказана сходимость методов оценки достаточного объема выборок из простой генеральной совокупности.
    \item Разработаны методы мультидоменной дистилляции и анти-дистилляции для передачи знаний между моделями различной сложности и между различными доменами данных.
    \item Для многозадачного обучения доказаны теоремы о статистической состоятельности низкоранговых адаптеров и снижении эмпирической сложности.
\end{enumerate}
\end{frame}
%----------------------------------------------------------------------------------------------------------
\end{document}