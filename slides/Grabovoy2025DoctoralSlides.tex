...
\begin{frame}{}
    \centering
    {\Huge \textbf{Ландшафтные меры для разных архитектур}}
...
Для $L$-слойной полносвязной сети с ReLU получена оценка скорости сходимости ландшафта:
...
Ландшафтная мера сложности полносвязной модели:
\[
