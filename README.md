<div align="center">
  <H1>
    О сложности моделей и данных в современных моделях глубого обучения
  </H1>
...
## Аннотация
Работа посвящена проблеме построения единого теоретического аппарата для оценки сложности моделей и данных при обучении моделей глубокого обучения. В отличие от классических методов, таких как VC-размерность и PAC-обучение, предлагаемый подход устанавливает формальную связь между сложностью модели и сложностью выборки через критерий обучаемости. В работе введены определения сложности модели и данных, а также ландшафтная мера сложности, основанная на анализе ландшафта оптимизационной задачи и спектральных свойств матриц Гессе. Получены теоретические оценки спектральных норм для полносвязных, сверточных, трансформерных архитектур и других архитектур. Разработаны методы определения достаточного объема выборки на основе сэмплирования эмпирической ошибки и близости апостериорных распределений, а также алгоритмы снижения сложности моделей, включая дистилляцию и анти-дистилляцию. Результаты апробированы в задачах многозадачного обучения, нейровизуализации и детекции машинно-генерированного контента.
